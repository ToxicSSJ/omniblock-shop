...
public class UserShop extends AbstractShop {
	...
	public void waitItem(Player player) {
		...
		sign.setLine(3, TextUtil.format(actionType == ShopActionType.BUY ? "venderas" : "compraras") + ".");
		
		player.sendMessage(TextUtil.format("&8&lT&8iendas &b&l(!) &7Ahora debes hacer click derecho con el item que usaras en la tienda."));
